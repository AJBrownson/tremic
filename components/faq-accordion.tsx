    ...
    <>
      ...
      >
        <AccordionItem value="item-1">
          <AccordionTrigger className="font-medium lg:text-base text-blue-900 bg-[#F9F9F9] px-5 hover:no-underline cursor-pointer">
            What areas do you service?
          </AccordionTrigger>
          <AccordionContent className="text-base lg:text-sm text-[#626262] bg-[#F9F9F9] pl-5 pr-10">
