    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="relative h-[300px] w-full">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4">
          <h1 className="text-5xl md:text-7xl font-bold text-center mb-6">about us</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Discover how AquaFlow became a leader in water systems installation and management.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
              <Image
                ...
                alt="AquaFlow Founding Team"
                fill
                className="object-cover"
              />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-blue-800 mb-4">From Humble Beginnings to Industry Leaders</h3>
              <p className="text-gray-700 mb-4">
                Founded in 2008 by a team of water engineers with a vision to revolutionize water management systems,
                AquaFlow began as a small residential service provider in Clearwater, Florida. What started as a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20 md:grid-flow-dense">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg md:order-2">
              <Image
                src="/placeholder.svg?height=400&width=600"
                alt="AquaFlow Technology and Innovation"
                fill
                className="object-cover"
              />
            </div>
            <div className="md:order-1">
              <h3 className="text-2xl font-bold text-blue-800 mb-4">Our Approach to Water Systems</h3>
              <p className="text-gray-700 mb-4">
                At AquaFlow, we believe that water management is both a science and an art. Our approach combines
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
              <Image
                src="/placeholder.svg?height=400&width=600"
                alt="AquaFlow Sustainability Initiatives"
                fill
                className="object-cover"
              />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-blue-800 mb-4">Commitment to Sustainability</h3>
              <p className="text-gray-700 mb-4">
                Water is our most precious resource, and we take our responsibility as stewards of this resource
                seriously. AquaFlow is at the forefront of developing and implementing water conservation technologies
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-blue-800 mb-3">Quality Excellence</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-blue-800 mb-3">Sustainability</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 px-4 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/contact-us"
            className="bg-white text-blue-900 hover:bg-blue-100 px-8 py-3 rounded-md font-medium transition-colors inline-block"
          >
            GET IN TOUCH
          </Link>
        </div>
